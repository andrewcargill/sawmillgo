...
const EditLog = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setLog({ id: logSnap.id, ...logData });
  
        const projects = await fetchProjectsForSawmill(db, sawmillId, logData.verified);
        ...
        console.error("Error fetching log or projects:", error);
        alert(error.message);
      }
    }
  ...
  const handleSpeciesChange = (event) => {
    ...
    setLog((prev) => ({
      ...prev,
      speciesId: value,
      speciesName: specie ? specie.name : "",
    }));
  };
